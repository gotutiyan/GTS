...
class EvalInfo:
    def __init__(self, is_modified: bool, is_correct: bool, judge: bool) -> None:
        self.is_modified = is_modified
        self.is_correct = is_correct
        self.judge = judge

    def show(self) -> None:
        print("is_modified: {}, is_correct: {}, judge: {}".format(self.is_modified,
                                                                  self.is_correct,
                                                                  self.judge))
        return
...
class Score:
    ...
    def get_PRFA(self) -> None:
        ...
        try: self.F05 = float(1.25*self.Precision*self.Recall)\
